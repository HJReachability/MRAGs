...
\begin{aligned}
\dotxam{i}(t) &= \vela\cam{i}(t), & \xam{i}(0) = \xanm{i},\\
\dotxbm{i}(t) &= \velb\cbm{i}(t), & \xbm{i}(0) = \xbnm{i},\\
& i=1,2,\ldots,\N
\end{aligned}
\eq
...
%For the two-player reach-avoid game, we seek to the following: Given joint initial state of the attacker and defender $\xjn$ and the target $\target$, can the defender be guaranteed to win? 