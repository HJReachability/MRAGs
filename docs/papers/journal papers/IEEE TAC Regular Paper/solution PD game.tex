...
For convenience, we will also use $\dist(\cdot,\cdot)$ with one or both arguments being sets in $\amb$. In this case, $\dist(\cdot,\cdot)$ will denote the shortest distance between the objects in the two arguments.
